...
TEST=checkpoint-6000-64.4/whole_model.bin
#TEST=checkpoint-12600-66.0/whole_model.bin
...
MODEL_TYPE=t5
ATTACK=insert2
SAVED_PATH=../../result/ft5-2w/
LANGUAGE=java
OUTPUT=../../result/ft51_java2c
TRAIN_FILE=./data/
EVAL_FILE=./data/
...
ADAM_EPS=1e-6
MAX_STEPS=12000
WARMUP_STEPS=1400 # 0.1 of max steps
SAVE_STEPS=2000  #
BEAM_SIZE=1
TEST_STEP=12000
