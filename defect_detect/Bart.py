...
class Bart_Classification(nn.Module):
    ...
    def __init__(self, model, config, args, max_length=None, sos_id=None, eos_id=None):
        super(Bart_Classification, self).__init__()
        ...
        for name, module in reversed(list(self.model.named_modules())):
            ...
            # print('******************')
            if name == 'decoder.layers.5.fc2':
                print('previous weight ', module.weight)
                self._init_weights(module)
                print('after weight  ', module.weight)
